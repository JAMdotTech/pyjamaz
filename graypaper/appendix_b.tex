...
\newcommand{\equationbpointtwo}{
    \begin{align}
        F \in \Omega\ang{\{\}} \colon
...
\newcommand{\equationbpointthree}{\pvm \equiv \tuple{\isa{\mathbf{p}}{\Y}, \isa{\mathbf{u}}{\ram}, \isa{i}{\N_R}}}
\newcommand{\equationbpointfour}{
    \begin{align}
...
\newcommand{\equationbpointseven}{\forall \mathbf{x} \in \mathbf{X} : \mathbf{x}_\mathbf{s} \equiv (\mathbf{x}_\mathbf{u})_\mathbf{d}[\mathbf{x}_s]}
\newcommand{\equationbpointeight}{
    \begin{align}
...
\newcommand{\equationbpointeleven}{
    \begin{align}
...
\newcommand{\equationbpointtwelve}{
    \begin{align}
...
\newcommand{\equationbpointseventeen}{\gascounter' \equiv \gascounter - g}
\newcommand{\equationbpointeighteen}{
    \begin{align}
...
\newcommand{\equationbpointeighteenhostgk}{
    \begin{align}
...
\newcommand{\equationbpointeighteenhostgv}{
    \begin{aligned}
        \registers'_7 \equiv \gascounter'
    \end{aligned}
}
\newcommand{\equationbpointeighteenhostlk}{
    \begin{align}
...
\newcommand{\equationbpointeighteenhostlv}{
    \begin{align}
...
\newcommand{\equationbpointeighteenhostrk}{
    \begin{align}
...
\newcommand{\equationbpointeighteenhostrv}{
    \begin{align}
        \using s^* = \begin{cases}
...
\newcommand{\equationbpointeighteenhostwk}{
    \begin{align}
...
\newcommand{\equationbpointeighteenhostwv}{
    \begin{align}
...
\newcommand{\equationbpointeighteenhostik}{
    \begin{align}
...
\newcommand{\equationbpointeighteenhostiv}{
    \begin{align}
...
\newcommand{\equationbpointnineteen}{\gascounter' \equiv \gascounter - g}
\newcommand{\equationbpointtwenty}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostbk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostbv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentyhostak}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostav}{
    \begin{aligned}
        \using o = \registers_8 \\
...
\newcommand{\equationbpointtwentyhostdk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostdv}{
    \begin{aligned}
        \using o = \registers_7 \\
        \using \mathbf{v} = \begin{cases}
...
\newcommand{\equationbpointtwentyhostck}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostcv}{
    \begin{aligned}
        \mathbf{y'} \equiv \mathbf{x} \\
        \registers'_7 \equiv \gascounter'
    \end{aligned}
}
\newcommand{\equationbpointtwentyhostnk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostnv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentyhostuk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostuv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentyhosttk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhosttv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentyhostjk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostjv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentyhostqk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostqv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentyhostsk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostsv}{
    \begin{aligned}
        \using [o, z] = \registers_{7, 8} \\
        \using h = \begin{cases}
            \memory_{o\dots+32} \when \mathbb{Z}_{o \dots+ 32} \subset \mathbb{V}_{\memory} \\
...
\newcommand{\equationbpointtwentyhostfk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostfv}{
    \begin{aligned}
        \using [o, z] = \registers_{7, 8} \\
        \using h = \begin{cases}
            \memory_{o\dots+32} \when \mathbb{Z}_{o \dots+ 32} \subset \mathbb{V}_{\memory} \\
...
\newcommand{\equationbpointtwentyhostariesk}{
    \begin{align}
...
\newcommand{\equationbpointtwentyhostariesv}{
    \begin{aligned}
        \using o = \registers_7 \\
        \using h = \begin{cases}
            \memory_{o\dots+32} \when \mathbb{Z}_{o \dots+ 32} \subset \mathbb{V}_{\memory} \\
...
\newcommand{\equationbpointtwentyone}{\gascounter' \equiv \gascounter - g}
\newcommand{\equationbpointtwentytwo}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohosthk}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohosthv}{
    \begin{aligned}
        \using \mathbf{a} = \begin{cases}
...
\newcommand{\equationbpointtwentytwohostyk}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohostyv}{
    \begin{aligned}
        \using \mathbf{v} = \begin{cases}
...
\newcommand{\equationbpointtwentytwohostek}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohostev}{
    \begin{aligned}
        \using p = \registers_7 \\
...
\newcommand{\equationbpointtwentytwohostmk}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohostmv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentytwohostpk}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohostpv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentytwohostok}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohostov}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentytwohostzk}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohostzv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentytwohostvk}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohostvv}{
    \begin{aligned}
        \using [n, p, c] = \registers_{7 \dots 10} \\
        \using \mathbf{u} = \begin{cases}
            \mathbf{m}[n]_\mathbf{u} \when n \in \keys{\mathbf{m}} \\
...
\newcommand{\equationbpointtwentytwohostkk}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohostkv}{
    \begin{aligned}
...
\newcommand{\equationbpointtwentytwohostxk}{
    \begin{align}
...
\newcommand{\equationbpointtwentytwohostxv}{
    \begin{aligned}
        \using n = \registers_7 \\
        (\registers'_7, \mathbf{m}') \equiv \begin{cases}
