...
\( {% include-markdown "./section_11.tex" comments=false %} \)
...
|-----------------------------|-----------------------------------|----------------|
| <a name="11.1">(11.1)</a>   | $\equationelevenpointone$         | [TODO]         | 

### 11.1.1. Work Report 
| Graypaper                   | Equation                          | Implementation |
|-----------------------------|-----------------------------------|----------------|
| <a name="11.2">(11.2)</a>   | $\equationelevenpointtwo$         | [TODO]         |
| <a name="11.3">(11.3)</a>   | $\equationelevenpointthree$       | [TODO]         |

### 11.1.2. Refinement Context 
| Graypaper                   | Equation                          | Implementation |
|-----------------------------|-----------------------------------|----------------|
| <a name="11.4">(11.4)</a>   | $\equationelevenpointfour$        | [TODO]         |

### 11.1.3. Availability 
| Graypaper                   | Equation                          | Implementation |
|-----------------------------|-----------------------------------|----------------|
| <a name="11.5">(11.5)</a>   | $\equationelevenpointfive$        | [TODO]         |
...
| <a name="11.26">(11.26)</a> | $\equationelevenpointtwentysix$   | [TODO]         |
...
| <a name="11.34">(11.34)</a> | $\equationelevenpointthirtyfour$  | [TODO]         |
| <a name="11.35">(11.35)</a> | $\equationelevenpointthirtyfive$  | [TODO]         |
| <a name="11.36">(11.36)</a> | $\equationelevenpointthirtysix$   | [TODO]         |
| <a name="11.37">(11.37)</a> | $\equationelevenpointthirtyseven$ | [TODO]         |
| <a name="11.38">(11.38)</a> | $\equationelevenpointthirtyeight$ | [TODO]         |
