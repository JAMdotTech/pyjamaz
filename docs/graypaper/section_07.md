...
|-------------------------|----------------------------|----------------|
| <a name="7.1">(7.1)</a> | $\equationsevenpointone$   | [TODO]         | 
| <a name="7.2">(7.2)</a> | $\equationsevenpointtwo$   | [TODO]         |
| <a name="7.3">(7.3)</a> | $\equationsevenpointthree$ | [TODO]         |
| <a name="7.4">(7.4)</a> | $\equationsevenpointfour$  | [TODO]         |
