...
\( {% include-markdown "./section_08.tex" comments=false %} \)
# 8. Authorization
...
|-------------------------|----------------------------|----------------|
| <a name="8.1">(8.1)</a> | $\equationeightpointone$   | [TODO]         | 
| <a name="8.2">(8.2)</a> | $\equationeightpointtwo$   | [TODO]         |
| <a name="8.3">(8.3)</a> | $\equationeightpointthree$ | [TODO]         |
