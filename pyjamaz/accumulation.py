...
from pyjamaz.settings import THREAD_POOL_MAX_WORKERS, USE_THREAD_POOL
...
async def full_sequential_accumulation(
    ...
    output = await parallel_accumulation(
    ...
    second_output = await full_sequential_accumulation(
