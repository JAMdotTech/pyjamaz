...
# TODO: docker image seems to invalidate earlier compiled files...
#       might need to patch: https://numba.discourse.group/t/containerized-application-without-recompilation-at-startup/1637
