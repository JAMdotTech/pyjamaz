...
#                 return sync_state_and_return_jit(reg, registers_out, state_out, EXIT_PANIC,
#                                                  pc, gas, inst_nr,
...
#                 return sync_state_and_return_jit(reg, registers_out, state_out, EXIT_HOST_HALT,
#                                                  pc, gas, inst_nr,
...
#                     return sync_state_and_return_jit(reg, registers_out, state_out, EXIT_PAGE_FAULT,
#                                                      pc, gas, inst_nr,
...
#                     skip_len = I64(0)
#                     return sync_state_and_return_jit(reg, registers_out, state_out, EXIT_HALT,
#                                                      pc, gas, inst_nr,
#                                                      exit_value, skip_len, ERROR_NONE)
...
#                                                          section_arrays, acl_dict)
#                 if status_read != I32(0):
#                     return sync_state_and_return_jit(reg, registers_out, state_out, EXIT_PAGE_FAULT, pc, gas, inst_nr,
#                                                  exit_value, skip_len, ERROR_MEMORY_FAULT)
...
#                 if logg: log(logging, local_state, reg, context="error: unknown opcode",
#                                 mem=section_arrays, mem_starts=mem_section_starts, mem_ends=mem_section_ends)
#                 return sync_state_and_return_jit(reg, registers_out, state_out, EXIT_PANIC, pc, gas, inst_nr,
#                                                  exit_value, skip_len, ERROR_PANIC_TRAP)
#
...
#                 reg[r_a] = pvm_X_jit(rori32_aot(U32(w_b), U32(v_x)), U8(4))
#                 if logg: log(logging, local_state, reg, reg1=r_a, reg2=r_b, imm1=v_x,
#                                 context="w'_a: " + str(reg[r_a]) + " w_b: " + str(w_b), mem=section_arrays)
#
#             elif opcode == op_rot_r_32_imm_alt:
#                 reg[r_a] = pvm_X_jit(rori32_aot(U32(v_x), U32(w_b)), U8(4))
#                 if logg: log(logging, local_state, reg, reg1=r_a, reg2=r_b, imm1=v_x,
#                                 context="w'_a: " + str(reg[r_a]) + " w_b: " + str(w_b), mem=section_arrays)
#
#             else:
...
#                 if djump_result == I32(-1):
#                     skip_len = I64(0)
#                     return sync_state_and_return_jit(reg, registers_out, state_out, EXIT_HALT, pc, gas, inst_nr,
#                                                      exit_value, skip_len, ERROR_NONE)
#                 elif djump_result == I32(-2):
#                     return sync_state_and_return_jit(reg, registers_out, state_out, EXIT_PANIC, pc, gas, inst_nr,
#                                                      exit_value, skip_len, ERROR_PANIC_INVALID_DJUMP)
...
#                                     context="w'_d: " + str(reg[r_d]), mem=section_arrays)
#                 else:
#                     reg[r_d] = pvm_Z_inv_jit(pvm_rtz_div_aot(I64(a_signed), I64(b_signed)), U8(8))
#                     if logg: log(logging, local_state, reg, reg1=r_d, reg2=r_a, reg3=r_d,
#                                     context="w'_d: " + str(reg[r_d]), mem=section_arrays)
#
...
#                                     context="w'_d: " + str(reg[r_d]), mem=section_arrays)
#                 else:
#                     reg[r_d] = pvm_Z_inv_jit(pvm_smod_aot(a_signed, b_signed), U8(8))
#                     if logg: log(logging, local_state, reg, reg1=r_d, reg2=r_a, reg3=r_d,
#                                     context="w'_d: " + str(reg[r_d]), mem=section_arrays)
#
...
#                                     context="w'_d: " + str(reg[r_d]), mem=section_arrays)
#                 else:
#                     reg[r_d] = pvm_Z_inv_jit(pvm_rtz_div_aot(pvm_Z_jit(w_a, 8), pvm_Z_jit(w_b, 8)), U8(8))
#                     if logg: log(logging, local_state, reg, reg1=r_d, reg2=r_a, reg3=r_d,
#                                     context="w'_d: " + str(reg[r_d]), mem=section_arrays)
#
...
#                 reg[r_d] = pvm_X_jit(roli32_aot(U32(w_a), U32(U32(w_b) & U32(31))), U8(4))
#                 if logg: log(logging, local_state, reg, reg1=r_d, reg2=r_a, reg3=r_d,
#                                 context="w'_d: " + str(reg[r_d]), mem=section_arrays)
#
...
#                 reg[r_d] = pvm_X_jit(rori32_aot(U32(w_a), U32(U32(w_b) & U32(31))), U8(4))
#                 if logg: log(logging, local_state, reg, reg1=r_d, reg2=r_a, reg3=r_d,
#                                 context="w'_d: " + str(reg[r_d]), mem=section_arrays)
#
...
# Build with:  python pyjamaz/pyjamaz/pvm/numba/interpreter_numba_aot2.py
# Produces:    interpreter_numba_aot2.* (shared object)
...
# Make sure these signatures match the ones you compiled for in the JIT module.
from .interpreter_numba_jit import (  # noqa: E402
    # entry point
    invoke_native as invoke_native_jit,
    # optional direct exports (uncomment if you want to expose individually)
    # mem_read_jit, mem_write_jit, read_uint_jit,
    # pvm_X_jit, pvm_Z_jit, pvm_Z_inv_jit,
    # branch_jit, djump_jit, sbrk_jit,
    # sync_state_and_return,
)
