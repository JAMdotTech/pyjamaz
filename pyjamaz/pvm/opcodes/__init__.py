...
from pyjamaz.pvm.opcodes.imm import _op_ecalli
from pyjamaz.pvm.opcodes.imm_imm import _op_store_imm_u8, _op_store_imm_u16, _op_store_imm_u32, _op_store_imm_u64
from pyjamaz.pvm.opcodes.none import _op_fallthrough, _op_invalid, _op_trap
from pyjamaz.pvm.opcodes.offset import _op_jump
from pyjamaz.pvm.opcodes.reg_ext_imm import _op_load_imm_64
from pyjamaz.pvm.opcodes.reg_imm import _op_jump_ind, _op_load_imm, _op_load_u8, _op_load_i8, _op_load_u16, _op_load_i16, \
    _op_load_u32, _op_load_i32, _op_load_u64, _op_store_u8, _op_store_u16, _op_store_u32, _op_store_u64
from pyjamaz.pvm.opcodes.reg_imm_imm import _op_store_imm_ind_u8, _op_store_imm_ind_u16, _op_store_imm_ind_u32, \
    _op_store_imm_ind_u64
from pyjamaz.pvm.opcodes.reg_imm_offset import _op_load_imm_jump, _op_branch_eq_imm, _op_branch_ne_imm, _op_branch_lt_u_imm, \
...
from pyjamaz.pvm.opcodes.reg_reg import _op_move_reg, _op_sbrk, _op_count_set_bits_64, _op_count_set_bits_32, \
...
from pyjamaz.pvm.opcodes.reg_reg_imm import _op_store_ind_u8, _op_store_ind_u16, _op_store_ind_u32, _op_store_ind_u64, \
...
from pyjamaz.pvm.opcodes.reg_reg_imm_imm import _op_load_imm_jump_ind
from pyjamaz.pvm.opcodes.reg_reg_offset import _op_branch_eq, _op_branch_ne, _op_branch_lt_u, _op_branch_lt_s, _op_branch_ge_u, \
    _op_branch_ge_s
from pyjamaz.pvm.opcodes.reg_reg_reg import _op_add_64, _op_add_32, _op_sub_32, _op_mul_32, _op_div_u_32, _op_div_s_32, \
