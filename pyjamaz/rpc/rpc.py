...
from pyjamaz.rpc.jsonapi import (
    RPC_ERROR,
    RPC_TYPE_REQUEST,
    RPC_TYPE_SUBSCRIBE,
    RPC_TYPE_UNSUBSCRIBE,
    RPCCallException,
    generate_req_id,
    jsonapi_error,
    jsonapi_parse as base_jsonapi_parse,
    jsonapi_request,
    jsonapi_response,
    jsonapi_ws_response,
    jsonapi_ws_subscribed,
)
...
def jsonapi_parse(message):
    return base_jsonapi_parse(message, RPC_REQUESTS)
