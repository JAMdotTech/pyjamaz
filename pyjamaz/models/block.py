from pyjamaz.graypaper_constants import VALIDATOR_COUNT,MAXIMUM_EXTRINSIC_TICKETS
from scalecodec.base import ScaleType, ScaleBytes
from scalecodec.types import Struct, H256, U32, Option, Vec, H512, U8, Bool, VecType, Compact, Bytes, BitVec

from pyjamaz.models.common import Ticket, WorkReport
...
class ExtrinsicAssurance(Struct):
    ...
    arguments = {
        ...
        'is_available': BitVec(), # GP-ref:116-120,f
