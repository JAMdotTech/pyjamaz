...
class EntropyOutput(Serializable):
    """
    GP-0.7.1-eq:4.8 (η') | Output of Entropy STF.

    Attributes
    ----------
    post_state: EntropyState
        GP-0.7.1-eq:4.8 (η') | Primary output of Entropy STF.
    """
...
class ValidatorArchiveOutput(Serializable):
    """
    GP-0.7.1-eq:4.10 (λ') | Output of ValidatorArchive STF.

    Attributes
    ----------
    post_state: ValidatorArchiveState
        GP-0.7.1-eq:4.10 (λ') | Primary output of ValidatorArchive STF.
    """
...
class ValidatorPoolOutput(Serializable):
    """
    GP-0.7.1-eq:4.9 (κ') | Output of ValidatorPool STF.

    Attributes
    ----------
    post_state:ValidatorPoolState
        GP-0.7.1-eq:4.9 (κ') | Primary output of ValidatorPool STF.
    """
...
class SafroleOutput(Serializable):
    """
    GP-0.7.1-eq:4.7 (γ') | Output of Safrole STF.

    Attributes
    ----------
    post_state: SafroleState
        GP-0.7.1-eq:4.7 (γ') | Primary output of Safrole STF.
    epoch_mark: Option(EpochMark)
        GP-0.7.1-eq:6.27 (bold_H_E) | Secondary output of Safrole STF.
    tickets_mark: Option(Array(TicketBody, EPOCH_TIMESLOTS))
        GP-0.7.1-eq:6.28 (bold_H_W) | Secondary output of Safrole STF.
    """
...
class AuthorizerPoolsOutput(Serializable):
    """
    GP-0.7.1-eq:4.19 (α') | Output of AuthorizerPools STF.

    Attributes
    ----------
    post_state:AuthorizerPoolsState
        GP-0.7.1-eq:4.19 (α') | Primary output of AuthorizerPools STF.
    """
...
class AssurancesAfterDisputesOutput(Serializable):
    """
    GP-0.7.1-eq:4.12 (ρ†) | Output of AssurancesAfterDisputes STF.

    Attributes
    ----------
    intermediate_state_after_disputes:AssurancesState
        GP-0.7.1-eq:4.12 (ρ†) | Primary output of AssurancesAfterDisputes STF.
    """
...
class AssurancesAfterAssurancesOutput(Serializable):
    """
    GP-0.7.1-eq:4.13 (ρ‡) | Output of AssurancesAfterAssurances STF.

    Attributes
    ----------
    intermediate_state_after_assurances: AssurancesState
        GP-0.7.1-eq:4.13 (ρ‡) | Primary output of AssurancesAfterAssurances STF.
...
class AssurancesAfterGuaranteesOutput(Serializable):
    """
    GP-0.7.1-eq:4.14 (ρ') | Output of AssurancesAfterGuarantees STF.

    Attributes
    ----------
    post_state: AssurancesState
        GP-0.7.1-eq:4.14 (ρ') | Primary output of AssurancesAfterGuarantees STF.
...
class StatisticsOutput(Serializable):
    """
    GP-0.7.1-eq:4.20 (π') | Output of Statistics STF.

    Attributes
    ----------
    post_state:StatisticsState
        GP-0.7.1-eq:4.20 (π') | Primary output of Statistics STF.
    """
...
class AccumulationHistoryOutput(Serializable):
    """
    GP-0.7.1-eq:4.16 (ξ') | Output of Accumulation History STF.

    Attributes
    ----------
    post_state: AccumulationHistoryState
        GP-0.7.1-eq:4.16 (ξ') | Primary output of AccumulationHistory STF.
    """
...
class AccumulationQueueOutput(Serializable):
    """
    GP-0.7.1-eq:4.16 (θ') | Output of Accumulation Queue STF.

    Attributes
    ----------
    post_state: ServicesState
        GP-0.7.1-eq:4.16 (θ') | Primary output of AccumulationQueue STF.
    """
