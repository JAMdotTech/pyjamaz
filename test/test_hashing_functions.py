...
from pyjamaz.hashing import blake2b_256_hash, blake2b_128_hash, blake2b_64_hash, keccak_256_hash
...
class TestHashingFunction(unittest.TestCase):
    def test_blake_2b_256(self):
        ...
        digest_hex = blake2b_256_hash(data).hex()
    ...
    def test_blake_2b_128(self):
        ...
        digest_hex = blake2b_128_hash(data).hex()
    ...
    def test_blake_2b_64(self):
        ...
        digest_hex = blake2b_64_hash(data).hex()
    ...
    def test_keccak_256(self):
        ...
        digest_hex = keccak_256_hash(data).hex()
