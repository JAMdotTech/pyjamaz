...
class TestVarInt29(unittest.TestCase):
    def test_scale_encode(self):
        ...
        self.assertEqual('0xc3e8', var_int.encode(1000).to_hex())
        self.assertEqual('0xe4e093', var_int.encode(300000).to_hex())
        self.assertEqual('0xffffff', var_int.encode(2**21-1).to_hex())
    ...
    def test_scale_decode(self):
        ...
        self.assertEqual(2**29-1, var_int.decode(ScaleBytes('0xffffffff')))
