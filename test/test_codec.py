...
from pyjamaz.models.common import WorkDigest, RefinementContext, WorkReport
...
class TestCodec(unittest.TestCase):
    ...
    def test_jdt_state_assurances(self):
        ...
        with open(path.join(self.test_vector_jdt_dir, f'state_assurances.bin'), "rb") as f:
           jam_data = f.read()
        self.assertEqual(jam_data.hex(), state.to_jam_bytes().to_bytes().hex())

    def test_jdt_state_authorizer_pools(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_authorizer_pools.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_jdt_dir, f'state_authorizer_pools.bin'), "rb") as f:
           jam_data = f.read()
        self.assertEqual(jam_data.hex(), state.to_jam_bytes().to_bytes().hex())

    def test_jdt_state_authorizer_queues(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_authorizer_queues.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_jdt_dir, f'state_authorizer_queues.bin'), "rb") as f:
           jam_data = f.read()
        self.assertEqual(jam_data.hex(), state.to_jam_bytes().to_bytes().hex())

    def test_jdt_state_disputes(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_disputes.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_jdt_dir, f'state_disputes.bin'), "rb") as f:
           jam_data = f.read()
        self.assertEqual(jam_data.hex(), state.to_jam_bytes().to_bytes().hex())

    def test_jdt_state_entropy(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_entropy.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_jdt_dir, f'state_entropy.bin'), "rb") as f:
           jam_data = f.read()
        self.assertEqual(jam_data.hex(), state.to_jam_bytes().to_bytes().hex())

    def test_jdt_state_privileged_services(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_privileged_services.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_jdt_dir, f'state_privileged_services.bin'), "rb") as f:
           jam_data = f.read()
        self.assertEqual(jam_data.hex(), state.to_jam_bytes().to_bytes().hex())

    def test_jdt_state_recent_history(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_recent_history.json')) as f:
            test_vector = json.load(f)
    ...
    def test_jdt_state_safrole(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_safrole.json')) as f:
            test_vector = json.load(f)
    ...
    def test_jdt_state_statistics(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_statistics.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_jdt_dir, f'state_statistics.bin'), "rb") as f:
            jam_data = f.read()
        self.assertEqual(jam_data.hex(), state.to_jam_bytes().to_bytes().hex())

    def test_jdt_state_timeslot(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_timeslot.json')) as f:
            test_vector = json.load(f)
    ...
    def test_jdt_state_validator_archive(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_validator_archive.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_jdt_dir, f'state_validator_archive.bin'), "rb") as f:
           jam_data = f.read()
        self.assertEqual(jam_data.hex(), state.to_jam_bytes().to_bytes().hex())

    def test_jdt_state_validator_pool(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_validator_pool.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_jdt_dir, f'state_validator_pool.bin'), "rb") as f:
           jam_data = f.read()
        self.assertEqual(jam_data.hex(), state.to_jam_bytes().to_bytes().hex())

    def test_jdt_state_validator_queue(self):
        with open(path.join(self.test_vector_jdt_dir, f'state_validator_queue.json')) as f:
            test_vector = json.load(f)
    ...
    def test_w3f_extrinsic_assurances(self):
        ...
        with open(path.join(self.test_vector_w3f_dir, f'assurances_extrinsic.bin'), "rb") as f:
           jam_data = f.read()
    ...
    def test_w3f_block(self):
        with open(path.join(self.test_vector_w3f_dir, f'block.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'block.bin'), "rb") as f:
           jam_data = f.read()
    ...
    def test_w3f_extrinsic_disputes(self):
        with open(path.join(self.test_vector_w3f_dir, f'disputes_extrinsic.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'disputes_extrinsic.bin'), "rb") as f:
           jam_data = f.read()
    ...
    def test_w3f_extrinsic(self):
        ...
        with open(path.join(self.test_vector_w3f_dir, f'extrinsic.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'extrinsic.bin'), "rb") as f:
           jam_data = f.read()

        self.assertEqual(jam_data.hex(), extrinsic.to_jam_bytes().to_bytes().hex())

    def test_w3f_extrinsic_guarantees(self):
        with open(path.join(self.test_vector_w3f_dir, f'guarantees_extrinsic.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'guarantees_extrinsic.bin'), "rb") as f:
           jam_data = f.read()
    ...
    def test_w3f_header(self):
        for n in [0, 1]:
            with open(path.join(self.test_vector_w3f_dir, f'header_{n}.json')) as f:
                test_vector = json.load(f)
            ...
            with open(path.join(self.test_vector_w3f_dir, f'header_{n}.bin'), "rb") as f:
                jam_data = f.read()

            self.assertEqual(jam_data.hex(), header.to_jam_bytes().to_bytes().hex())

    def test_w3f_extrinsic_preimages(self):
        with open(path.join(self.test_vector_w3f_dir, f'preimages_extrinsic.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'preimages_extrinsic.bin'), "rb") as f:
           jam_data = f.read()
    ...
    def test_w3f_refine_context(self):
        with open(path.join(self.test_vector_w3f_dir, f'refine_context.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'refine_context.bin'), "rb") as f:
           jam_data = f.read()

        self.assertEqual(jam_data.hex(), refine_context.to_jam_bytes().to_bytes().hex())

    def test_w3f_extrinsic_tickets(self):
        with open(path.join(self.test_vector_w3f_dir, f'tickets_extrinsic.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'tickets_extrinsic.bin'), "rb") as f:
           jam_data = f.read()
    ...
    def test_w3f_work_item(self):
        with open(path.join(self.test_vector_w3f_dir, f'work_item.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'work_item.bin'), "rb") as f:
           jam_data = f.read()

        self.assertEqual(jam_data.hex(), work_item.to_jam_bytes().to_bytes().hex())

    def test_w3f_work_package(self):
        with open(path.join(self.test_vector_w3f_dir, f'work_package.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'work_package.bin'), "rb") as f:
           jam_data = f.read()

        self.assertEqual(jam_data.hex(), work_package.to_jam_bytes().to_bytes().hex())

    def test_w3f_work_report(self):
        with open(path.join(self.test_vector_w3f_dir, f'work_report.json')) as f:
            test_vector = json.load(f)
        ...
        with open(path.join(self.test_vector_w3f_dir, f'work_report.bin'), "rb") as f:
           jam_data = f.read()
    ...
    def test_w3f_work_result(self):
        for n in [0, 1]:
            with open(path.join(self.test_vector_w3f_dir, f'work_result_{n}.json')) as f:
                test_vector = json.load(f)
            ...
            with open(path.join(self.test_vector_w3f_dir, f'work_result_{n}.bin'), "rb") as f:
                jam_data = f.read()
