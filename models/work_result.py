...
class WorkResult(Struct):
    #GP-equation: 114,115 | "RESULT"->"(SERVICE_IDX,CODE_HASH,PAYLOAD_HASH,GAS_PRIORITIZATION_RATIO,RESULT)" | "SERVICE_IDX"->"U32" | "CODE_HASH"->"H256" | "PAYLOAD_HASH"->"H256" | "GAS_PRIORITIZATION_RATIO"->"I64" | "RESULT"->"ENUM<OUTPUT,ENUM<OUT-OF-GAS,UNEXPECTED-TERMINATION,BAD,BIG>>" | "OUTPUT"->"BYTES"
